import winreg, os, socket, sqlite3, file_decompressor, pf_data
        ...
        try:
            ...
            with open(file_name, "w") as getLocation:
                if option is None:
                        ...
                        for file_name in files:
                            ...
                            if os.path.splitext(file_path)[1] == ".pf":
                                ...
                                if file_header[4:] == b'SCCA':
                                    ...
                                    decompressed_file_path = file_path[:-3] + '_decompressedFile.pf'
                                    ...
                                    if not os.path.exists(decompressed_file_path):
                                        ...
                                        print("Prefetch dosyası okunamadı!")
                    ...
                    Functions.error("Parametre hatalı!")

        except Exception as e:
            print(f"Error: {file_name} : {e}")
            Functions.error(f"Error: {file_name} : {e}")
